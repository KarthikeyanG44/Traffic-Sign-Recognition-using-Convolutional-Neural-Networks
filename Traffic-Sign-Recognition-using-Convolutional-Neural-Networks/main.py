...
if __name__=='__main__':
    ...
    ## Data Augmentation for train and test time using various transforms ##
    ...
    data_folder = r'E:\Gatech Fall 2019\DIP\Final Project\Data'
    train_folder = os.path.join(data_folder,'Train\Final_Training\Images')
    ...
    val_loader = torch.utils.data.DataLoader(
        datasets.ImageFolder(validation_folder,
                             transform=data_transforms),
